...
namespace UNICODE_8 {
	const unsigned char LINES[] = {
		...
		static_cast<unsigned char>(179), //	0000 1100
		static_cast<unsigned char>(195), //	0000 1101
		static_cast<unsigned char>(180), //	0000 1110
		static_cast<unsigned char>(197), //	0000 1111
		'#', '#', '#', '#', '#',
		...
		'#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#',
		static_cast<unsigned char>(206), //	1111 1111
	};
	...
	void print()
	{
		std::for_each(LINES, LINES + LINES_SIZE,
